...
public function testArticleStoreFails() {
    ...
    labore et dolore magna aliqua.", "writer" => "Ujang");
...
eiusmod tempor incididunt ut labore et dolore magna aliqua.", "writer"=> "Ujang");
$post = $this->action('POST', 'ArticlesController@store', $data);
}
...
incididunt ut labore et dolore magna aliqua.", "writer" => "Ujang");
